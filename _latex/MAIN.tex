...
%----------HEADING----------
\begin{center}
    \textbf{\Huge Noppayut Sriwatanasakdi} \\ \vspace{5pt}
%    \small \faPhone* \texttt{555.555.5555} \hspace{1pt} $|$
    \hspace{1pt} \faEnvelope \hspace{2pt} \texttt{noppayut@gmail.com} \hspace{1pt} $|$ 
    \hspace{1pt} \faGlobe \hspace{2pt} \url{https://noppayut.github.io} \hspace{1pt} $|$
    \hspace{1pt} \faGithub \hspace{2pt}\href{https://github.com/noppayut}{\texttt{noppayut}}\hspace{1pt} $|$
    \hspace{1pt} \faLinkedin \hspace{2pt}\href{https://www.linkedin.com/in/noppayut/}{\texttt{noppayut}}
    \\ \vspace{-3pt}
\end{center}
